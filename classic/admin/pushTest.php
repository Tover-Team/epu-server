...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="bbs/push_notifiaction_test.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">푸시 발송내용</label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">이동할 링크 경로를 입력하세요</label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">이미지 경로</label>
