...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if($is_on=="on"){
        $message_status = send_notification_ios($title_content, $message_content, $mb_link, $mb_image, $google);
        $message_status = send_notification_android($title_content, $message_content, $mb_link, $mb_image, $google);
    }
