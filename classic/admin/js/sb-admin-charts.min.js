...
var ctx=document.getElementById("myAreaChart"),
    myLineChart=new Chart(ctx,{type:"line",
        data:{
        labels:["월","Mar 2","Mar 3","Mar 4","Mar 5","Mar 6","Mar 7","Mar 8","Mar 9","Mar 10","Mar 11","Mar 12","Mar 13"],
            datasets:[{label:"Sessions",
                ...
                pointHitRadius:20,
                pointBorderWidth:2,
                data:[1e4,124,124,124,124,124,124,124,124,124,124,1000,2000]
        }]},
        options:{scales:
        ...
        ctx,{type:"bar",data:
            ...
            options:{scales:{xAxes:[{time:{unit:"month"},
                ...
                yAxes:[{ticks:{min:0,max:15e3,maxTicksLimit:5},
                    gridLines:{display:!0}}]},legend:{display:!1}}}),
