...
if ($is_admin == 'super' || $is_app_admin) // 최고관리자 통과
    ;
...
// 게시글 삭제
$result = sql_query(" delete from $write_table where wr_parent = '{$write['wr_id']}' ");
$result = sql_query(" delete from $write_table where wr_id = '{$write['wr_id']}' ");
echo $result;
echo " delete from $write_table where wr_parent = '{$write['wr_id']}' ";
