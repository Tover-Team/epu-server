...
CREATE TABLE IF NOT EXISTS `g5_member` (
  ...
  `img_1` varchar(255) NOT NULL default '',
  `img_2` varchar(255) NOT NULL default '',
  `img_3` varchar(255) NOT NULL default '',
  `img_4` varchar(255) NOT NULL default '',
  `img_5` varchar(255) NOT NULL default '',
  `img_6` varchar(255) NOT NULL default '',
  `img_7` varchar(255) NOT NULL default '',
  `img_8` varchar(255) NOT NULL default '',
  `img_9` varchar(255) NOT NULL default '',
  `img_10` varchar(255) NOT NULL default '',
  `mb_position` varchar(255) NOT NULL default '',
  `mb_grade` varchar(255) NOT NULL default '',
  `mb_latitude` varchar(255) NOT NULL default '',
  `mb_longitude` varchar(255) NOT NULL default '',
  `push_token` varchar(255) NOT NULL default '',
  `store_type` varchar(255) NOT NULL default '',
  `is_push_receive` varchar(255) NOT NULL default '',
  `receive_change` datetime NOT NULL default '0000-00-00 00:00:00',
  PRIMARY KEY  (`mb_no`),
