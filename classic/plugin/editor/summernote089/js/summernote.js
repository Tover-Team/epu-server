...
var toolbar = renderer.create('<div class=""><div class="note-toolbar2" style="background: #F5F5F5"></div></div>');
...
var ui = {
    ...
    createLayout: function ($note, options) {
        ...
        return {
            note: $note,
            editor: $editor,
            toolbar: $editor.find('.note-toolbar2'),
...
var Buttons = /** @class */ (function () {
    ...
    Buttons.prototype.addToolbarButtons = function () {
        ...
        // _this.context.createInvokeHandler('editor.resize', '0.5')
