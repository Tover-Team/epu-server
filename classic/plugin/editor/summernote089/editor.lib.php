...
function editor_html($id, $content, $is_dhtml_editor=true)
{
	...
	if ($is_dhtml_editor && $js) {
        ...
        ob_start();
?>
<link rel="stylesheet" href="<?php echo $editor_url ?>/css/bootstrap.css">
<link rel="stylesheet" href="<?php echo $editor_url ?>/css/summernote.css">
<script src="<?php echo $editor_url ?>/js/jquery.js"></script>
<script src="<?php echo G5_JS_URL ?>/jquery.bxslider.js"></script>
<script src="<?php echo $editor_url ?>/js/bootstrap.js"></script>
<script src="<?php echo $editor_url ?>/js/summernote.js"></script>
...
<script src="<?php echo $editor_url ?>/js/config.js"></script>
...
<?php       
    ...
    $html .= "\n<textarea id=\"summernote\" name=\"$id\" class=\"$summernote_class\" >{$content}</textarea>";
