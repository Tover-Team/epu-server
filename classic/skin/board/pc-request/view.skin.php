...
<script type="text/javascript">
    ...
    function answer(table, wr_id) {
        ...
        if (confirm("답변을 등록하시겠습니까?") == true){
            var url = '<?php echo G5_URL."/api/board/"?>';
            $.ajax({
                type : 'get',
                url : url,
                data :{
                ...
                <form>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon3" style="font-size: 17px;">답변</span>
                        </div>
                        <textarea style="font-size: 17px;" type="text" class="form-control" id="wr_10" cols="40" rows="8" ><?php echo $view['wr_10']; ?></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn" onclick="answer('<?php echo $bo_table;?>', '<?php echo $wr_id;?>')">등록</button>
    ...
    <div class="panel-heading">
        ...
        <div class="card card-sm">
            <div class="card-body row no-gutters align-items-center">
                <a onclick="openPopup()">
                    <button type="button" class="btn btn-primary  btn-lg" style="height: 35px;">답변등록</button>
                </a>
            </div>
        </div>
    </div>
