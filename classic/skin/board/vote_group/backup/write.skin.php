		...
		<?php } ?>
            ...
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4">
                            <input type="date" name="wewewewe" id="wewewewe" value="<?php $today = date("Y-m-d"); echo $write['wr_startDate'] != "" ? $write['wr_startDate'] : $today ?>" required class="form-control input-sm"  disabled>
                            <input style="display: none" type="date" name="wr_startDate" id="wr_startDate" value="<?php  $today = date("Y-m-d"); echo $write['wr_startDate'] != "" ? $write['wr_startDate'] :  $today ?>" required class="form-control input-sm" >
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4">
                            <input type="date" name="wr_endDate" id="wr_endDate" value="<?php echo $write['wr_endDate'] ?>" required class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
		...
		<table class="table div-table">
            ...
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_5" id="wr_5" value="<?php echo $write['wr_5']; ?>" required class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_6" id="wr_6" value="<?php echo $write['wr_6']; ?>" required class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_7" id="wr_7" value="<?php echo $write['wr_7']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_8" id="wr_8" value="<?php echo $write['wr_8']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_9" id="wr_9" value="<?php echo $write['wr_9']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_10" id="wr_10" value="<?php echo $write['wr_10']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_11" id="wr_11" value="<?php echo $write['wr_11']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_12" id="wr_12" value="<?php echo $write['wr_12']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_13" id="wr_13" value="<?php echo $write['wr_13']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_14" id="wr_14" value="<?php echo $write['wr_14']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_15" id="wr_15" value="<?php echo $write['wr_15']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_16" id="wr_16" value="<?php echo $write['wr_16']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_17" id="wr_17" value="<?php echo $write['wr_17']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_18" id="wr_18" value="<?php echo $write['wr_18']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_19" id="wr_19" value="<?php echo $write['wr_19']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_20" id="wr_20" value="<?php echo $write['wr_20']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_21" id="wr_21" value="<?php echo $write['wr_21']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_22" id="wr_22" value="<?php echo $write['wr_22']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_23" id="wr_23" value="<?php echo $write['wr_23']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_24" id="wr_24" value="<?php echo $write['wr_24']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
