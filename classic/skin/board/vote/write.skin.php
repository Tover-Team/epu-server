...
$now = date("Y-m-d");
$end_date = $write['wr_endDate'];
$str_now = strtotime($now);
$str_target = strtotime($end_date);

// 진행중 && 지금이 종료일보다 적으면
$isOngoing = $write['wr_2'] == "1" && $str_now <= $str_target;
...
<div id="bo_w" class="write-wrap<?php echo (G5_IS_MOBILE) ? ' font-14' : ''; ?>">
    ...
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);"
          method="post" enctype="multipart/form-data" autocomplete="off" role="form" class="form">
            ...
            <table class="table div-table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-4">
                                <input type="text" style="display: none" name="is_group" id="is_group" value="N">
                                <input type="text" style="display: none" name="is_sub" id="is_sub" value="N">
                                <?php

                                // 수정글이면
                                if ($write['wr_startDate'] != "") {
                                    if ($isOngoing) {
                                        ?>
                                        <input type="datetime-local" name="wr_startDate" id="wr_startDate"
                                               value="<?php echo date('Y-m-d\TH:i:s', strtotime($write['wr_startDate']) ) ?>"
                                        ...
                                        <input type="datetime-local" name="wr_startDate" id="wr_startDate"
                                               value="<?php echo date('Y-m-d\TH:i:s', strtotime($write['wr_startDate']) ) ?>"
                                               required class="form-control input-sm" disabled>
                                        <?php
                                    }
                                } else {
                                    ?>
...
<!--                                <input style="display: none" type="datetime-local" name="wr_startDate" id="wr_startDate"-->
<!--                                       value="--><?php //echo $write['wr_startDate'] != "" ? date('Y-m-d\TH:i:s', strtotime($write['wr_startDate']) ): $today ?><!--" required-->
<!--                                       class="form-control input-sm">-->
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-4">
                                <input type="datetime-local" name="wr_endDate" id="wr_endDate"
                                       value="<?php
                                       echo $write['wr_endDate'] ? date('Y-m-d\TH:i:s', strtotime($write['wr_endDate'])) : $today ?>" required
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </td>
            ...
            <table class="table div-table">
                ...
                <tr style="display: none;">
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-4 col-xs-6">
                                <input type="text" name="wr_2" id="wr_2" value="1" required
                                       class="form-control input-sm">
                                <input type="text" name="wr_content" id="wr_content" value="1" required
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-4 col-xs-6">
                                <input type="text" name="wr_5" id="wr_5" value="<?php echo $write['wr_5']; ?>" required
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-4 col-xs-6">
                                <input type="text" name="wr_6" id="wr_6" value="<?php echo $write['wr_6']; ?>" required
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-4 col-xs-6">
                                <input type="text" name="wr_7" id="wr_7" value="<?php echo $write['wr_7']; ?>"
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-4 col-xs-6">
                                <input type="text" name="wr_8" id="wr_8" value="<?php echo $write['wr_8']; ?>"
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-4 col-xs-6">
                                <input type="text" name="wr_9" id="wr_9" value="<?php echo $write['wr_9']; ?>"
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </td>
                    ...
                    <?php if ($is_name) { ?>
                        <tr style="display: none">
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <input type="text" name="wr_name" value="guest" id="wr_name" required
                    ...
                    <?php if ($is_password) { ?>
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <input type="password" name="wr_password"
                    ...
                    <?php if ($is_homepage) { ?>
                        <tr style="display: none">
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" name="wr_homepage" id="wr_homepage" value="d"
        ...
        <div class="write-btn">
            <button type="submit" id="btn_submit" accesskey="s" class="btn btn-<?php echo $btn2; ?> btn-sm"><i
                        class="fa fa-check"></i> <b>작성완료</b></button>
            <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn btn-<?php echo $btn1; ?> btn-sm"
               role="button">취소</a>
        </div>
