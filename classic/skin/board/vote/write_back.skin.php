		...
		<?php } ?>
            ...
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4">
                            <input type="date" name="wewewewe" id="wewewewe" value="<?php $today = date("Y-m-d"); echo $today ?>" required class="form-control input-sm"  disabled>
                            <input style="display: none" type="date" name="wr_startDate" id="wr_startDate" value="<?php $today = date("Y-m-d"); echo $today ?>" required class="form-control input-sm" >
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4">
                            <input type="date" name="wr_endDate" id="wr_endDate" value="<?php echo $wr_endDate ?>" required class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
		...
		<table class="table div-table">
            ...
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_5" id="wr_5" value="<?php echo $wr_data['wr_5']; ?>" required class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_6" id="wr_6" value="<?php echo $wr_data['wr_6']; ?>" required class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_7" id="wr_7" value="<?php echo $wr_data['wr_7']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_8" id="wr_8" value="<?php echo $wr_data['wr_8']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-sm-4 col-xs-6">
                            <input type="text" name="wr_9" id="wr_9" value="<?php echo $wr_data['wr_9']; ?>"  class="form-control input-sm">
                        </div>
                    </div>
                </td>
            </tr>
