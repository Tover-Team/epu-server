...
<div class="dobddfox" style="margin-top:10px;clear:both;height:65px;background:white;width:100%;border:1px solid #c3c3c3;margin-bottom:5px;line-height: 65px;">



	<div class="" style="width:100%;float:left;text-align: center;background: #1dc116;color: #fff">
									...
									<div class="list-text">
										...
										<div class="list-info font-14 en">
											<div class="pull-left" title="평균 <?php echo sprintf("%2.1f", $vstar['score']);?> / <?php echo $vstar['cnt'];?>명 참여">
                                                <?php echo "상태: "?><?php echo $list[$i]['wr_2'] == "1" ? "진행" : "종료";?>
<!--												--><?php //echo $vstar['star'];?>
											</div>
