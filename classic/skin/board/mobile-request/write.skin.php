	...
	<div class="form-group">
		<div class="col-sm-10">
			<div class="input-group">
				<input type="text" style="height: 60px; line-height: 60px;" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control input-sm" size="50" maxlength="255" placeholder="제목을 입력하세요.">
                <input style="display: none" type="text" style="height: 60px; line-height: 60px;" name="app_user_id" value="<?php echo $memID ?>" id="app_user_id" required class="form-control input-sm" size="50" maxlength="255" placeholder="제목을 입력하세요.">
			</div>
		</div>
	</div>
        <div class="form-group">
            <div class="col-sm-10" style="padding: 15px;margin-left: 15px">
                <?php
                if ($is_anonymous == "") {
                 ?>
                    <input type='checkbox' name='is_anonymous' value='익명' />  해당 버튼을 체크하시면 관리자와 본인만 확일 할 수 있는 비밀게시글로 게시됩니다.
                 <?php
                } else {
                    ?>
                    <input type='checkbox' name='is_anonymous' value='익명'  checked="true"/>  해당 버튼을 체크하시면 관리자와 본인만 확일 할 수 있는 비밀게시글로 게시됩니다.
                    <?php
                }
                ?>
                <br>
...
<!--		</div>-->
    ...
    <div class="write-btn pull-center">
        ...
        <a href="http://epu8541.cafe24.com/endapp.html" class="btn btn-black btn-sm" role="button">취소</a>
