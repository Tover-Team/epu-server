...
<div class="form-group">
	<label class="col-sm-2 control-label hidden-xs">마크</label>
	<div class="col-sm-10">
		...
		<span id="ticon" class="talker-photo"><?php echo apms_fa($write['as_icon']);?></span>
		&nbsp;
...
<div class="form-group">
	...
	<div class="col-sm-3">
		<div class="control-label input-group input-group-sm">
			...
			<input type="text" name="wr_1" value="<?php echo ($is_new) ? $fr_date : $write['wr_1'];?>" id="wr_1" <?php echo $is_required;?> class="form-control input-sm" size="10" maxlength="20">
	...
	<div class="col-sm-3">
		<div class="control-label input-group input-group-sm">
			...
			<input type="text" name="wr_2" value="<?php echo ($is_new) ? $fr_date : $write['wr_2'];?>" id="wr_2" <?php echo $is_required;?> class="form-control input-sm" size="10" maxlength="20">
			<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		</div>
		<div class="h10 visible-xs"></div>
	</div>
	<div class="col-sm-3">
		<div class="control-label input-group input-group-sm">
			...
			<select name="wr_3" id="wr_3" class="form-control input-sm">
				...
				<?php echo apms_color_options($write['wr_3']);?>
			</select>
...
$(function(){
	$("#wr_1, #wr_2").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yymmdd", showButtonPanel: true, yearRange: "c-2:c+3" });
