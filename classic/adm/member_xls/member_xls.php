...
<div class="new_win">
    ...
    <form name="mbxlsupdate" method="post" action="./member_xls_update.php" enctype="MULTIPART/FORM-DATA" autocomplete="off">
    ...
    <div class="btn_confirm01 btn_confirm">
        <input type="button" class="btn_submit" value="등록된 회원 다운로드" onclick="document.location.href='./member_xls_download.php';">
        <input type="submit" value="회원정보수정 엑셀파일 등록" class="btn_submit">
        <button type="button" onclick="window.close();">닫기</button>
    </div>
